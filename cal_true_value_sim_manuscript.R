...
###asymmetric trimming weights under each case for additional simulations in paper
###PS is also in the outcome model m^{(a)}
...
for(L in L_set){
  for(gamma in gamma_set){
    ...
    true_eff_trun1 <- true_eff_trun2 <- true_eff_trun3 <- matrix(0, nrow=nsim, ncol=3)
    ...
    for(i in 1:nsim){
      ...
      ###truncated iptw
      true_eff_trun1[i,1] = true_eff_trun2[i,1] = true_eff_trun3[i,1]=true_eff_iptw[i,1]
      true_eff_trun1[i,2] = true_eff_trun2[i,2] = true_eff_trun3[i,2]=true_eff_iptw[i,2]
      true_eff_trun1[i,3] = true_eff_trun2[i,3] = true_eff_trun3[i,3]=true_eff_iptw[i,3]
      ###ow
      true_eff_ow[i,1] = ow1
      true_eff_ow[i,2] = ow0
    ...
    colMeans(true_eff_trun1)
    colMeans(true_eff_trun2)
    colMeans(true_eff_trun3)
    
    write.csv(data.table('true_eff_ow' = colMeans(true_eff_ow),
                         'true_eff_iptw' = colMeans(true_eff_iptw), 
                         ...
                         'true_eff_trun1' = colMeans(true_eff_trun1),
                         'true_eff_trun2' = colMeans(true_eff_trun2),
                         'true_eff_trun3' = colMeans(true_eff_trun3)),
